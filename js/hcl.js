...
chips['false'] = ({
  name: 'false',
  description: 'Always outputs false',
  color: 'purple',
  generics: {
    x: '1'
  },
...
Chip = (function() {
  ...
  Chip.prototype.connect = function(chip, output, input) {};
  return Chip;
})();
exports.Chip = Chip;
...
modules['debug'] = function(){
	...
	var exports = exportsObj['debug'] = {};

	var __slice = Array.prototype.slice;
exports.createDebug = function(container) {
  return function() {
    var variable, variables, _i, _len, _results;
    variables = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    _results = [];
    for (_i = 0, _len = variables.length; _i < _len; _i++) {
      variable = variables[_i];
      _results.push(console.log("" + variable + ":\t " + container[variable]));
    }
    return _results;
  };
};
